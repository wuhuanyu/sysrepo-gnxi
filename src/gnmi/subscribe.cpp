 ...
 */
    ...
    Status Subscribe::handleStreamOnChange(ServerContext *context, SubscribeRequest *request,
                                           ServerReaderWriter<SubscribeResponse, SubscribeRequest> *stream) {
        return Status::OK;
    }

    Status Subscribe::buildSubscribeAsyncNotification(Notification *notification,
                                                      const SubscriptionList &request) {
        return Status::OK;
    }
